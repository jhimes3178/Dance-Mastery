...
const DANCE_STYLES_DATABASE = [
  {
    ...
    moves: {
      beginner: [
        { name: "The Bounce", videoUrl: "https://youtube.com/shorts/Rd4eG4CTJ7E?is=9oar1B7d6TJOyd2A" },
  ...
  },
  {
    name: "Ballet",
    moves: {
      beginner: ["Plie", "Releve", "Tendu", "Dégagé", "Rond de Jambe", "Coupe", "Passe", "Arabesque", "Chasse", "Changement", "Battement", "Port de Bras"],
  ...
  },
  {
    name: "Contemporary",
    moves: {
      beginner: ["Flat Back", "Parallel Plie", "Floor Melt", "Undercurve", "Overcurve", "Prance", "Lateral T-Shape", "Swing Drop", "Contraction", "Release", "Weight Shift", "Floor Slide"],
  ...
  },
  {
    name: "Jazz",
    moves: {
      beginner: ["Jazz Walk", "Sharp Head Turn", "Hip Roll", "Shoulder Drop", "Chest Isolation", "Pivot Turn", "Step Ball Change", "Kick Ball Change", "Jazz Drag", "Passe Jump", "Fan Kick", "Three-Step Turn"],
  ...
  },
  {
    name: "Dancehall",
    moves: {
      beginner: ["The Wine", "Log On", "Sufferer", "Bogle", "Chaka Chaka", "Scooby Doo", "Signal the Plane", "Pon Di River", "Drive By", "Overproof", "Summer Bounce", "Zip It Up"],
  ...
  },
  {
    name: "Tahitian Dance",
    moves: {
      beginner: ["Tamau", "Ami", "Varu Basic", "Fa'arapu Basic", "Tairi Tamau", "Hura Step", "Oveo Step", "Slide Step", "Hand Wave", "Ocean Motion Arms", "Flower Frame Pose", "Toe Tap Step"],
  ...
  },
  {
    name: "West African",
    moves: {
      beginner: ["Soli Step", "Kuku Groove", "Sorsornet Slide", "Lamba Step", "Yankadi Walk", "Dundunba Kick", "Mandiani Shrug", "Kakilambe Bounce", "Aconcon Reach", "Sinte Step", "Balanta Hop", "Djole Jump"],
  ...
  },
  {
    name: "Line Dancing",
    moves: {
      beginner: ["Grapevine", "V-Step", "Charleston Step", "Jazz Box", "Coaster Step", "Sailor Step", "Pivot Turn", "Heel Dig", "Toe Strut", "Hip Bumps", "Scuff Step", "Slide Step"],
  ...
  },
  {
    name: "Afrobeat",
    moves: {
      beginner: ["Gbese", "Kupe", "Azonto Step", "Shaku Shaku", "Zanku Step", "Network Step", "Pilolo", "Gwara Gwara Basic", "Happy Feet", "Shoulder Roll Bounce", "Leg Swing Drop", "Side Wave"],
  ...
  },
  {
    name: "Latin Fusion",
    moves: {
      beginner: ["Salsa Forward Basic", "Bachata Side Basic", "Merengue March", "Samba Step Base", "Cha Cha Side Step", "Underarm Lead", "Cross Body Guide", "Hip Swivel Rock", "Side Step-Touch", "Cuddle Position Hold", "Spot Turn", "Diagonal Salsa Glide"],
  ...
  },
  {
    name: "Bollywood",
    moves: {
      beginner: ["The Thumka", "Wrist Roll", "Step-Touch Diagonal", "Shoulder Shrug", "Hand Lotus Frame", "Toe-Heel Bounce", "Side Slide Arm Roll", "The Bhangra Hop", "Garba Circle Step", "Foot Tap with Clap", "Forward Lean Shimmy", "Scarf Wave"],
  ...
  },
  {
    name: "Capoeira",
    moves: {
      beginner: ["Ginga", "Cadeira", "Meia Lua de Frente", "Cororinha", "Benção", "Armada", "Esquiva de Lado", "Negativa", "Role", "Au", "Queixada", "Passo à Frente"],
